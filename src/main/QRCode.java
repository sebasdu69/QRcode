...
public class QRCode {
	...
	public static void main(String[] args) throws WriterException, IOException, NotFoundException {
		...
		String room, bulding, subject, time, day;
		...
		room    = reader.getRoom   (readQRCode(filePath, charset, hintMap));
		bulding = reader.getBulding(readQRCode(filePath, charset, hintMap));
		subject = reader.getSubject(readQRCode(filePath, charset, hintMap));
		time    = reader.getTime   (readQRCode(filePath, charset, hintMap));
		day     = reader.getDay    (readQRCode(filePath, charset, hintMap));
		System.out.println("Day: "+day+"\nTime: "+time+"\nSubject: "+subject+"\nRoom: "+room+"\nBulding: "+bulding);
		
		QRSound sound = new QRSound();
		sound.playit(bulding);
	}
